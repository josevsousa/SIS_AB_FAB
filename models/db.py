...
Clientes = db.define_table('clientes',
    ...
    Field('celular', label='Celular',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='celular',_class='mask_celular')),
    Field('operadora', default=' operadora '),
    Field('fixo', label='Telefone',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='telefone',_class='mask_fixo')),
    Field('email',label='E-mail',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='e-mail')),
    Field('cnpj_cpf', label='CNPJ/CPF',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='cnpj/cpf',_class='mask_cnpj_cpf')),
    # Field('cpf', label='CPF'),
    Field('insc', label='INSC',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='insc',_class='mask_insc')),
    Field('cep', label='CEP',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='cep',_class='mask_cep')),
...
Funcionarios = db.define_table('funcionarios',
    ...
    Field('nome',label='Nome',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='nome')), 
    Field('celular', label='Celulares',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='celular',_class='mask_celular')),
    ...
    Field('fixo', label='Tel:..',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='telefone',_class='mask_fixo')),
    Field('email',label='E-mail',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='e-mail')),
    Field('cnpj_cpf', label='CNPJ/CPF',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='cnpj/cpf',_class='mask_cnpj_cpf')),
    Field('cep', label='CEP',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='cep',_class='mask_cep')),
...
Representantes = db.define_table('representantes',
    ...
    Field('nome',label='Nome',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='nome')), 
    Field('matricula', label='Matrícula'),
    Field('celular', label='Celula 1',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='celular - 1',_class='mask_celular')),
    Field('operadora', label='Op - 1', default='operadora'),
    Field('celular_2', label='Celula 2',widget=lambda field,value: SQLFORM.widgets.string.widget(field, value, _placeholder='celular - 2',_class='mask_celular')),
